    ...
    <Dialog>
      ...
      <DialogContent className="max-w-sm">
        ...
        <div className="space-y-0">
          <div className="grid grid-cols-4 gap-2 text-center py-5 border-b border-border">
            <div className="flex flex-col items-center">
              <Gamepad2 className="h-4 w-4 mb-2 text-muted-foreground" />
            ...
            <div className="flex flex-col items-center">
              <Flame className="h-4 w-4 mb-2 text-muted-foreground" />
            ...
            <div className="flex flex-col items-center">
              <Trophy className="h-4 w-4 mb-2 text-muted-foreground" />
                ...
                guessRanges.map((range) => {
                  ...
                  return (
                    <div key={range.label} className="flex items-center gap-2">
                      ...
                      <div className="flex-1 bg-muted h-6 relative border border-border">
                        <div
                          className="bg-foreground h-full flex items-center justify-end pr-2 transition-all text-background border-r-2 border-foreground"
                          style={{
                            width: `${Math.max(
                              percentage,
                              range.count > 0 ? 10 : 0
