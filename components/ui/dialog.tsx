...
const DialogTrigger = ({ className, ...props }: React.ComponentProps<typeof PrimitiveButton>) => (
...
const DialogClose = ({ variant = "outline", ref, ...props }: ButtonProps & { ref?: React.Ref<HTMLButtonElement> }) => {
