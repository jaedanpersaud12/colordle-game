  ...
  return (
    <span data-slot="control" className="relative block w-full">
      <InputPrimitive
        ref={ref}
        className={cx(
          "relative block w-full h-10 appearance-none rounded-none px-4",
          "text-base text-fg placeholder:text-muted-fg",
          "border border-border bg-background enabled:hover:border-muted-fg/30",
          "outline-hidden focus:border-ring focus:ring-2 focus:ring-ring/20 focus:enabled:hover:border-ring",
