        ...
        <div className="flex flex-col items-center text-center px-6 sm:px-12 py-12 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base sm:text-lg text-muted-foreground">
              {won ? (
                <>
                  You finished <span className="font-semibold text-foreground">{rating.label}</span> puzzle{" "}
                  in <span className="font-semibold text-foreground">{guessCount} {guessCount === 1 ? 'guess' : 'guesses'}</span>.
                </>
              ) : (
                <>
                  You attempted {guessCount} {guessCount === 1 ? 'guess' : 'guesses'}.
                </>
              )}
            </p>
          ...
          <div className="w-full space-y-3">
            <Button
              onClick={handleCopy}
              className="w-full h-12 text-base font-semibold rounded-full shadow-lg hover:shadow-xl transition-all"
              size="lg"
            >
              {copied ? (
                <>
